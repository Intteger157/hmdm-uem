...
public class Const {
    ...
    public static final String EXTRA_REMOTE_SESSION_ID = "remoteSessionId";
    public static final String EXTRA_REMOTE_PASSWORD = "remotePassword";
    public static final String EXTRA_REMOTE_SERVER_URL = "remoteServerUrl";
    public static final String EXTRA_REMOTE_SECRET = "remoteSecret";
    ...
    public static final String EXTRA_MDM_SERVER_URL = "mdmServerUrl";
    public static final String EXTRA_MDM_SERVER_PROJECT = "mdmServerProject";
